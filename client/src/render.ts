// ---------------------------------------------------------------------------
// The pub. A three.js scene: a bar along the back wall with the quiz master
// behind it, a big screen above the optics, stools, and floor space the
// contenders walk around. Every contender is a rig dressed from
// characters.ts; the module's per-player state drives the poses — phone out,
